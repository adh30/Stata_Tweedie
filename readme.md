...
White matter hyperintensities (WMH) are widely used as markers of brain small vessel disease. WMH volumes typically exhibit a **highly right-skewed distribution**. In some cases, such as younger people or for regional WMH volumes there may be a substantial proportion of zero volumes. This presents challenges for most Generalized linear models (GLMs) approaches.
